...
_TENSORSTOCLASSIFICATIONCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='binary_classification', full_name='mediapipe.TensorsToClassificationCalculatorOptions.binary_classification', index=3,
